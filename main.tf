...
module "bucket-raw" {
  ...
  name       = "datapipeline-combustiveis-raw"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-curated" {
  ...
  name       = "datapipeline-combustiveis-curated"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-tmp" {
  ...
  name       = "datapipeline-combustiveis-pyspark-tmp"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-code" {
  ...
  name       = "datapipeline-combustiveis-pyspark-code"
  project_id = var.project_id
  location   = var.region
}